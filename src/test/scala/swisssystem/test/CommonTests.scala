...
class CommonTests extends Specification {
  ...
  "Enumeration of pairs for odd participants with downfloater" should {
    val ps: List[Int] = List(1, 2, 3, 4, 5)
    val eps: Stream[Pairing[Int]] = Common.enumeratePairings(ps, Some(2))
    val epsl: List[Pairing[Int]] = eps.toList
    ...
    "produce pairings in the preferred order" in {
      epsl(0)  == Pairing[Int](List((1,5), (2,4)), Some(3)) &&
      epsl(1)  == Pairing[Int](List((1,5), (2,3)), Some(4)) &&
      epsl(2)  == Pairing[Int](List((1,4), (2,5)), Some(3)) &&
      epsl(3)  == Pairing[Int](List((1,4), (2,3)), Some(5)) &&
      epsl(4)  == Pairing[Int](List((1,3), (2,5)), Some(4)) &&
      epsl(5)  == Pairing[Int](List((1,3), (2,4)), Some(5)) &&
      epsl(6)  == Pairing[Int](List((1,2), (3,5)), Some(4)) &&
      epsl(7)  == Pairing[Int](List((1,2), (3,4)), Some(5)) &&
      epsl(8)  == Pairing[Int](List((1,2), (4,5)), Some(3)) &&
      epsl(9)  == Pairing[Int](List((2,5), (3,4)), Some(1)) &&
      epsl(10) == Pairing[Int](List((2,4), (3,5)), Some(1)) &&
      epsl(11) == Pairing[Int](List((2,3), (4,5)), Some(1))
    }
  }
}
